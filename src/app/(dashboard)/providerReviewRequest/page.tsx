...
import ProviderDetailsKycRequest from '@/components/providers/provider-details-kyc-request'
import ProviderDetailsAccepted from '@/components/providers/provider-details-accept'
import ProviderRejectionKycRequest from '@/components/providers/provider-rejection-kyc-request'
import ProviderKycRejectedDeclined from '@/components/providers/provider-kyc-rejected-declined'
...
const ProviderReviewRequest = () => {
    ...
    return (
        <div className='mt-8'>
            ...
            {/* modal component(USER_DETAILS_KYC_REQUEST) */}
            <CustomModal
                open={issOpenUserKyc}
                ...
                maxWidth={"!max-w-[40vw]"}
            >
                <ProviderDetailsKycRequest />
            </CustomModal>


            {/* modal component(USER_DETAILS_ACCEPTED) */}
            <CustomModal
                open={issOpen}
                setIsOpen={setIsOpen}
                className={"p-2 max-h-[50vh]"}
