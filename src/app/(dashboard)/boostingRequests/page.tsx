...
const BoostingRequests = () => {
    ...
    return (
        <div className='mt-8'>
                            ...
                            <TableRow key={user.id}>
                                ...
                                <TableCell className="text-right">
                                    <div className="flex justify-end gap-2">
                                        ...
                                        <button
                                            onClick={() => setBookingReqModal(!bookingReqModal)}
                                            className="cursor-pointer">
                                            <svg width="37" height="38" viewBox="0 0 37 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <button
                                            onClick={() => setBookingReqModalRej(!bookingReqModalRej)}
                                            className="cursor-pointer">
            ...
            <CustomModal
                open={bookingReqModal}
                setIsOpen={setBookingReqModal}
                className={"p-2 max-h-[0vh]"}
                maxWidth={"!max-w-[30vw]"}
            >
            ...
            {/* modal component(BOOSTING_REJECTED) */}
            <CustomModal
                open={bookingReqModalRej}
                setIsOpen={setBookingReqModalRej}
                className={"p-2 max-h-[0vh]"}
                maxWidth={"!max-w-[30vw]"}
            >
                <RejectBoosting />
...
export default BoostingRequests
