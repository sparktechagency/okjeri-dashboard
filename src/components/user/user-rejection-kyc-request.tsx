...
import KycRejectedDeclined from "./kyc-rejected-declined"

export default function UserRejectionKycRequest() {
    const [isOpen, setIsOpen] = useState(false)

    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Rejectig KYC request</h1>
