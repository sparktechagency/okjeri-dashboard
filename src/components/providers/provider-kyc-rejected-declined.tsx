...
interface KycRejectedDeclinedProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function ProviderKycRejectedDeclined({open,setIsOpen}:KycRejectedDeclinedProps) {
 
    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">KYC declined</h1>
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        This user&apos;s request is declined and he won&apos;t be able to book service and can&apos;t use other
                        services.
                    </p>
                    <Button
