...
const DeletePromotion:React.FC<DeletePromotionProps> = ({ open, setIsOpen }) => {
    return (
        <div>
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-4">
                    ...
                    <h2 className="text-[18px] font-semibold text-[#EF4444]">Are you sure to  delete <br /> this promotion image ?</h2>
                    <p className="text-[14px] text-[#AFAFAF] leading-relaxed">
                        Service providers will not be able to <br /> find this promotion.
                    </p>
