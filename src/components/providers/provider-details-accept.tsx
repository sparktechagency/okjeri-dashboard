...
interface UserDetailsAcceptedProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function ProviderDetailsAccepted({ open, setIsOpen }: UserDetailsAcceptedProps) {
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Now this user can book service, report providers and can use all the features of your app.
                    </p>
                    <Button
