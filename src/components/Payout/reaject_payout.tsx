...
import PayoutRejUndo from "./payout_rej_undo"



export default function ReajectPayout() {
    ...
    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Your are going to reject this payout</h1>
            ...
            {/* modal components(payout_rej_undo) */}
            <CustomModal
                open={isOpen}
                setIsOpen={setIsOpen}
