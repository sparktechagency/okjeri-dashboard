            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-4">
                    ...
                    <div className="flex justify-between gap-4 w-full">
                        <button className="w-[50%] border font-semibold  py-4 px-2 rounded-full">canecel</button>
                        <button className="w-[50%] bg-[#EF4444] text-[#ffff] font-semibold py-4 px-2 rounded-full">Yes, delete</button>
                    </div>
                </div>
            </div>
        </div>
