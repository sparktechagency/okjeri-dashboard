...
interface ServiceRequestAccepteProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function ServiceRequestAccepte({ open, setIsOpen }: ServiceRequestAccepteProps) {
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Now this Service is added the service list. Another provider can use it as his service.
                    </p>
                    <Button
