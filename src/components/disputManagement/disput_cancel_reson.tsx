...
import DisputCanceled from "./disput_canceled"


export default function DisputCancelReson() {
    const [isOpen, setIsOpen] = useState(false)

    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Your are going to cancel this booking</h1>
