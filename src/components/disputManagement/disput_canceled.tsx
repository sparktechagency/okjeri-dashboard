...
interface DisputCanceledProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function DisputCanceled({ open, setIsOpen }: DisputCanceledProps) {

    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Booking cancelled</h1>
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <h2 className="text-3xl font-semibold text-gray-900">Booking cancelled</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">

                        User and the provider both will get a notification about this action. User will get his refund within 24 hours.
                    </p>
                    <Button
