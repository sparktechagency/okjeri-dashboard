...
interface RefferalRejUndoProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function RefferalRejUndo({ open, setIsOpen }: RefferalRejUndoProps) {

    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Request rejected</h1>
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <h2 className="text-3xl font-semibold text-gray-900">Request rejected</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">

                        The provider won’t accept the amount of money that he requested for withdraw.
                    </p>
                    <Button
