...
interface RefferalAcceptedProps {
    open: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
}


export default function RefferalAccepted({ open, setIsOpen }: RefferalAcceptedProps) {

    return (
        <div>
            <h1 className="text-center text-[24px] pb-4">Request accepted</h1>
            ...
            <div className="flex flex-col items-center justify-center  bg-white p-4">
                <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      ...
                      The provider will get the money that he requested for withdraw.
                    </p>
                    <Button
